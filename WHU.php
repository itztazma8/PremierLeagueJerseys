...
<body>
    ...
    <main>
        ...
        <br>
        <div class="a1">
            <img src="CSS/Kits/WHH.jpg" class="im">
            <div id="a3">
                <h1 class="t1">23/24 West Ham Home Kit</h1>
                <p class="det">Taking inspiration from the famous club terrace song and now famous visual take to the pitch as the bubbles take to the sky of the London stadium.</p>
                <p class="det1">Size:</p>
        ...
        <div class="a1">
            <img src="CSS/Kits/WHA.jpg" class="im">
            <div id="a3">
                <h1 class="t1">23/24 West Ham Away Kit</h1>
                <p class="det">West Ham United unveiled our new 2023/24 Anthem Kit on Saturday - and it is available to pre-order now! This year's strip is a classic, elegant all-white outfit with subtle flashes of claret and blue.</p>
                <p class="det1">Size:</p>
...
if (isset($_POST['shirt']) || isset($_POST['home'])) {
    ...
    if (isset($_POST['but1'])) {
        ...
        if ($n==0) {
            if ($l1=='S') {
                ...
                VALUES ('WHU_H', '$l2', 90, '$l2',0,0,0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='M') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('WHU_H', '$l2', 90, 0,'$l2',0,0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='L') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('WHU_H', '$l2', 90, 0,0,'$l2',0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='XL') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('WHU_H', '$l2', 90, 0,0,0,'$l2',0)";
                mysqli_query($conn, $cc);
            } 
            else {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('WHU_H', '$l2', 90, 0,0,0,0,'$l2')";
                mysqli_query($conn, $cc);
            }
        }
    }
    ...
    if ($n==0) {
        if ($l1=='S') {
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('WHU_A', '$l2', 80, '$l2',0,0,0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='M') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('WHU_A', '$l2', 80, 0,'$l2',0,0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='L') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('WHU_A', '$l2', 80, 0,0,'$l2',0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='XL') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('WHU_A', '$l2', 80, 0,0,0,'$l2',0)";
            mysqli_query($conn, $cc);
        } 
        else {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('WHU_A', '$l2', 80, 0,0,0,0,'$l2')";
            mysqli_query($conn, $cc);
        }
    }
