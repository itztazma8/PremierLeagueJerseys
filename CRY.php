...
<body>
    ...
    <main>
        ...
        <br>
        <div class="a1">
            <img src="CSS/Kits/CRY_H.jpg" class="im">
            <div id="a3">
                <h1 class="t1">23/24 Crystal Palace Home Kit</h1>
                <p class="det">The front panel graphic of this Crystal Palace 23/24 Home Jersey recalls the original version of London's Crystal Palace, built in 1851 to house the Great Exhibition of 1851. The club traces its founding to this building. The jersey features traditional home red and blue stripe design with "EAGLES" printed on the back collar.
</p>
                <p class="det1">Size:</p>
        ...
        <div class="a1">
            <img src="CSS/Kits/CRY_A.jpg" class="im">
            <div id="a3">
                <h1 class="t1">23/24 Crystal Palace Away Kit</h1>
                <p class="det">Inspired by the colours of the historic shirt from 1861, the Crystal Palace FC away shirt for the 2023/24 season features a diagonal sky blue band, bearing the tone-on-tone wording 'CRYSTAL PALACE FOOTBALL CLUB FOUNDED 1861'</p>
                <p class="det1">Size:</p>
...
if (isset($_POST['shirt']) || isset($_POST['home'])) {
    ...
    if (isset($_POST['but1'])) {
        ...
        if ($n==0) {
            if ($l1=='S') {
                ...
                VALUES ('CRY_H', '$l2', 95, '$l2',0,0,0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='M') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('CRY_H', '$l2', 95, 0,'$l2',0,0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='L') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('CRY_H', '$l2', 95, 0,0,'$l2',0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='XL') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('CRY_H', '$l2', 95, 0,0,0,'$l2',0)";
                mysqli_query($conn, $cc);
            } 
            else {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('CRY_H', '$l2', 95, 0,0,0,0,'$l2')";
                mysqli_query($conn, $cc);
            }
        }
    }
    ...
    if ($n==0) {
        if ($l1=='S') {
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('CRY_A', '$l2', 80, '$l2',0,0,0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='M') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('CRY_A', '$l2', 80, 0,'$l2',0,0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='L') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('CRY_A', '$l2', 80, 0,0,'$l2',0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='XL') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('CRY_A', '$l2', 80, 0,0,0,'$l2',0)";
            mysqli_query($conn, $cc);
        } 
        else {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('CRY_A', '$l2', 80, 0,0,0,0,'$l2')";
            mysqli_query($conn, $cc);
        }
    }
