...
<body>
    ...
    <main>
        ...
        <br>
        <div class="a1">
            <img src="CSS/Kits/TOT_H.jpg" class="im">
            <div id="a3">
                <h1 class="t1">23/24 Tottenham Home Kit</h1>
                <p class="det">The 2023-24 Tottenham Hotspur home kit is combined with white shorts and white socks, which is typically reserved for European matches. It is the first time since the 2012-13 season that Tottenham have an all-Lilywhite Home Kit.</p>
                <p class="det1">Size:</p>
        ...
        <br>
        <div class="a1">
            <img src="CSS/Kits/TOT_A.png" class="im">
            <div id="a3">
                <h1 class="t1">23/24 Tottenham Away Kit</h1>
                <p class="det">The Nike Tottenham Hotspur FC 23-24 away shirt is the first in the club's history to have iridescent logos. Iridescent logos are nothing all-new for Nike kits. They have been used for England's 2022 Women's Euro kit and the Barcelona 21-22 away football shirt.
...
if (isset($_POST['shirt']) || isset($_POST['home'])) {
    ...
    if (isset($_POST['but1'])) {
        ...
        if ($n==0) {
            if ($l1=='S') {
                ...
                VALUES ('TOT_H', '$l2', 100, '$l2',0,0,0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='M') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('TOT_H', '$l2', 100, 0,'$l2',0,0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='L') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('TOT_H', '$l2', 100, 0,0,'$l2',0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='XL') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('TOT_H', '$l2', 100, 0,0,0,'$l2',0)";
                mysqli_query($conn, $cc);
            } 
            else {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('TOT_H', '$l2', 100, 0,0,0,0,'$l2')";
                mysqli_query($conn, $cc);
            }
        }
    }
    ...
    if ($n==0) {
        if ($l1=='S') {
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('TOT_A', '$l2', 85, '$l2',0,0,0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='M') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('TOT_A', '$l2', 85, 0,'$l2',0,0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='L') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('TOT_A', '$l2', 85, 0,0,'$l2',0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='XL') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('TOT_A', '$l2', 85, 0,0,0,'$l2',0)";
            mysqli_query($conn, $cc);
        } 
        else {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('TOT_A', '$l2', 85, 0,0,0,0,'$l2')";
            mysqli_query($conn, $cc);
        }
    }
