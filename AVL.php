...
<body>
    ...
    <main>
        ...
        <br>
        <div class="a1">
            <img src="CSS/Kits/AVL_H.jpeg" class="im">
            <div id="a3">
                <h1 class="t1">23/24 Aston Villa Home Kit</h1>
                <p class="det">All the styling of the team's own shirts are present including the classic claret and azure scheme and the iconic team crest on the chest.</p>
                <p class="det1">Size:</p>
        ...
        <div class="a1">
            <img src="CSS/Kits/AVL_A.jpg" class="im">
            <div id="a3">
                <h1 class="t1">23/24 Aston Villa Away Kit</h1>
                <p class="det">Carry your pride as a true Villan everywhere you go throughout the 2023-24 season with the official away kit. The Away shirt gives you the classic look of the Villa squad with great comfort for wearing every day.</p>
                <p class="det1">Size:</p>
...
if (isset($_POST['shirt']) || isset($_POST['home'])) {
    ...
    if (isset($_POST['but1'])) {
        ...
        if ($n==0) {
            if ($l1=='S') {
                ...
                VALUES ('AVL_H', '$l2', 90, '$l2',0,0,0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='M') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('AVL_H', '$l2', 90, 0,'$l2',0,0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='L') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('AVL_H', '$l2', 90, 0,0,'$l2',0,0)";
                mysqli_query($conn, $cc);
            }
            else if ($l1=='XL') {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('AVL_H', '$l2', 90, 0,0,0,'$l2',0)";
                mysqli_query($conn, $cc);
            } 
            else {
                
                $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
                VALUES ('AVL_H', '$l2', 90, 0,0,0,0,'$l2')";
                mysqli_query($conn, $cc);
            }
        }
    }
    ...
    if ($n==0) {
        if ($l1=='S') {
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('AVL_A', '$l2', 85, '$l2',0,0,0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='M') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('AVL_A', '$l2', 85, 0,'$l2',0,0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='L') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('AVL_A', '$l2', 85, 0,0,'$l2',0,0)";
            mysqli_query($conn, $cc);
        }
        else if ($l1=='XL') {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('AVL_A', '$l2', 85, 0,0,0,'$l2',0)";
            mysqli_query($conn, $cc);
        } 
        else {
            
            $cc="INSERT INTO kits (name, no, price, S, M, L, XL, XXL)
            VALUES ('AVL_A', '$l2', 85, 0,0,0,0,'$l2')";
            mysqli_query($conn, $cc);
        }
    }
